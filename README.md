...
# =============================================================================
# STM32项目构建配置文件
# 芯片: STM32F103ZETx | 工具链: gcc-arm-none-eabi
# =============================================================================

# -----------------------------------------------------------------------------
# 步骤1: CMake版本要求
#   指定CMake最低版本号，低于此版本会导致配置失败
#   【说明】3.25是当前主流版本，支持最新CMake特性
# -----------------------------------------------------------------------------
...
# 步骤2: 定义项目名称和编程语言
#   project(项目名 语言1 语言2 ...)
#   【说明】项目名用于生成elf文件名，这里是 ding26_4_15.elf
#   C/ASM表示项目使用C语言和汇编语言
# -----------------------------------------------------------------------------
...
# -----------------------------------------------------------------------------
# 步骤4: 收集所有源文件路径
#   SOURCES变量存储所有需要编译的.c和.s文件
#   【说明】CMake会根据扩展名自动选择合适的编译器
# -----------------------------------------------------------------------------
set(SOURCES
    # --- 应用程序代码 (Core层) ---
