...
**我们在main.c中完成一个简单的LED灯交替闪烁的功能**
```
HAL_GPIO_WritePin(GPIOE, GPIO_PIN_5, GPIO_PIN_SET);    // LED1亮
HAL_GPIO_WritePin(GPIOB, GPIO_PIN_5, GPIO_PIN_RESET);  // LED2灭
HAL_Delay(500);                                        // 延时500ms
HAL_GPIO_WritePin(GPIOE, GPIO_PIN_5, GPIO_PIN_RESET);  // LED1灭
HAL_GPIO_WritePin(GPIOB, GPIO_PIN_5, GPIO_PIN_SET);   // LED2亮
HAL_Delay(500);                                        // 延时500ms
```
